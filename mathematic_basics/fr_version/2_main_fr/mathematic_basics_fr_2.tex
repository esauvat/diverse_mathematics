...
\newcommand{\theorem}[2]{
    ...
    \begin{minipage}{0.7\textwidth} 
        \begin{#1} ${}$ \vspace*{0.15cm}\\ 
            \hspace*{20pt} \begin{blockarray}{|l} 
                #2 
            \end{blockarray} 
        \end{#1} 
    ...
    \hspace*{10pt}   \newtheorem*{#3}{#1}
        \begin{minipage}{0.7\textwidth} 
            \begin{#3} ${}$ \vspace*{0.15cm}\\ 
                \hspace*{18pt} \begin{blockarray}{|l} 
                    #2 
                \end{blockarray} 
            \end{#3} 
        \end{minipage} \vspace{-10pt} ~
...
\newcommand{\traitd}{\begin{center} ~ \medskip  \\ \rule{0.9\textwidth}{0.75pt} \vspace{-5pt}\end{center}}
\newcommand{\trait}{\begin{center} \rule{0.9\textwidth}{0.75pt} \end{center} ~ }
\newcommand{\traitdouble}{\trait \vspace{-40pt} \traitd}
...
\anothertoc{MPSI2}{Table des matières - Première année}{1}
\anothertoc{MPX}{Table des matières - Deuxième année}{1}	
