...
\section{Ouverts et fermés}
	...
	\subsection{Adhérence}
		...
		\begin{proof}
		On sait que la convergence d'une suite est invariante par norme équivalente (Page \pageref{1.3.1}) donc on a l'invariance des notions "point adhérent" et "adhérence" ainsi que "point intérieur" par le complémentaire de l'adhérence (Page \pageref{2.1.5}) puis par 
