...
\section{Convergences}
    ...
    \textit{Le Lemme suivant permet d'établir l'\underline{absence} de convergence uniforme}
        
    \theorem{lem}{
        Soit $f,f_n  :A\rightarrow F ~;~ B\subset A$ \textsc{alors} \\ 
    ...
    \textsc{Attention !} Faux sans la convergence uniforme !
    ...
    \theorem{lem}{
        Soit $f,f_n :A\rightarrow F$ \textsc{alors} \\ 
    ...
    \underline{Cas des fonctions bornées :} \\ 
...
\section{Série de fonctions}
    ...
    \theorem{thm}{
        ...
        \arf $ \textsc{alors} $\suminf g_k $ est $\cont^0$ au point $a$
    }
...
\section{Intégration et dérivation}
    \subsection{Cas général}
        ...
        \theorem{lem}{
            ...
            On suppose que $\varphi_n \ston \varphi$ \underline{uniformément sur tout segment de $I$} et on pose \\
        ...
        \theorem{thm}{
            ...
            \ard 
                ...
                \bullet~(f'_n)$ converge vers $h$ \underline{uniformément sur tout segment de $I$} $
            \arf\right.$ \\ 
            Alors $\ard 
        ...
        \begin{proof}
        \underline{Soit $a\in I$}, $\forall x\in I ,~f_n(x)-f_n(a) = \int_a^x f'_n (t) dt = \Phi_n(x) ,~\forall n\in\N$ \\
        ...
        \theorem{cor}{
            ...
            \ard 
                ...
                \bullet~\sum g'_n$ converge \underline{uniformément sur tout segment de $I$} $
            \arf\right.$ \\ 
            Alors $\ard 
...
\section{Approximations uniformes}
    ...
    \namedtheorem{Théorème de \textsc{Weierstrass}}{
        Toute fonction $f\in\cont^0([a,b],K)$ \underline{continue} sur un \underline{segment} y est limite uniforme \\ 
