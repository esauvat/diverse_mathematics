...
\section{Intégrale convergente}
	...
	\begin{proof}
		...
		Ainsi $F$ est majorée et par le Lemme 5.2.1 (\Cpageref{l512}) $\int_a^{\underline{b}} f$ converge
	\end{proof} \medskip
...
\section{Convergence absolue}
	...
	\begin{proof}
		...
		De même $\int_a^{\uline{b}} v$ converge et avec le Lemme 5.1.6 (\Cpageref{IntComplConv}) on a $\int_a^{\uline{b}} f$ converge
	\end{proof} \medskip
...
\section{Espace des fonctions intégrables sur $I$}
	...
	\begin{proof} Soit $I=[a,b[$ \vspace*{0.2cm}\\
		...
		\hspace*{0.5cm}\begin{blockarray}{|l}
			...
			Comme $\int_a^{\uline{b}} w$ cv, par le théorème de comparaison des fonctions positives (\Cpageref{ThCompFcPos}) \\
			on a $h\in L^1(I,K)$  
		\end{blockarray}\\
