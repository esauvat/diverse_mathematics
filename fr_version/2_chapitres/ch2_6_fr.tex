...
\section{Continuité et dérivation d'une intégrale paramétrée}
	...
	\begin{proof}
		...
		Soit $\alpha \in A$, on considère $\suite{x}$ telle que $x_n \ston \alpha$ et on a alors $\Phi(x_n) \ston \Phi(\alpha)$ par le théorème de convergence dominée puis par caractérisation séquentielle de la continuité (\Cpageref{CarSeqCont})\\ 
